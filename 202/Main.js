...
lado = 40; //Lado (Base de la piramide).
altura = 45; //Altura de la piramide

[v1, v2, v3, v4, v5] = 

[  
    [0, 0, 0], [lado, 0, 0], [lado, 0, lado], [0, 0, lado], [lado/2, altura, lado/2] 
]
...
color = [{color:0xFF8000}, {color:0xFF8000}];
...
// TRNSFORMADAS
//--------------------------------------------------------------------
// Se determinan cada uno de los valores de los parametros en las transformadas...
...
//SE AGREGAN AL ESCENARIO LOS ELEMENTOS
